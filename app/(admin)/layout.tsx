  ...
  return (
    <div className="flex h-screen bg-gray-100">
      <div
        ...
        } bg-black text-white flex flex-col transition-all duration-300 h-screen`}
      />
      {/* Sidebar */}
      <div
        className={`${
          isCollapsed ? "w-16" : "w-56"
        } bg-black text-white flex flex-col transition-all duration-300 h-screen fixed left-0 top-0`}
      >
        ...
        <button className="text-white absolute bottom-10 left-5 flex justify-center 
          ...
          <LogOut size={20}/> {!isCollapsed && <span>Đăng xuất</span>}
        </button>
      </div>
